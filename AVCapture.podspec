#
#  Be sure to run `pod spec lint AVCapture.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  AVCapture based on Apples demo code at https://developer.apple.com/library/mac/samplecode/AVRecorder/Listings/AVRecorder_AVCaptureDeviceFormat_AVRecorderAdditions_h.html
                   DESC
  ...
  s.frameworks = "CoreMedia", "AudioToolbox"
